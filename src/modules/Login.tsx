    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">Connectez-vous pour continuer à créer.</p>
        </div>
        ...
        <p className="text-center mt-8 text-slate-500 text-sm">
          Pas encore de compte ? <Link to="/signup" className="text-brand-primary hover:underline">Inscrivez-vous</Link>
        </p>
      </motion.div>
    </div>
  );
